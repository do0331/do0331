...
<style>
    .theme-box::before	{content:"　"; display:none;}
</style>
...
<div id="bo_gall" style="max-width:<?php echo $width; ?>">
    ...
    <ul id="gall_ul" class="gall_row">
        ...
        <div class="gall_box theme-box" style="background:url('<?=$list[$i]['wr_1']?>') center no-repeat;background-size:cover;height:<?=$list[$i]['is_notice']? "auto;":$board['bo_gallery_height']."px;"?>">
                <div class="gall_chk">
                <?php if ($is_checkbox) { ?>
                ...
                <div class="gall_con">  
                    <div class="subject2">
                        <div class="title"><?=$list[$i]['wr_subject'] ?></div>
                        <div class="hashtag"><?=$list[$i]['wr_content'] ?></div>
                    </div>
					<a href="<? echo $list[$i]['href'] ?>" class="bo_tit" >
