...
<?}
 ...
 if($is_viewer){?>
	...
	<!-- 게시물 하단 영역 -->
	<hr class="padding">
    <section id="bo_v_info" class="txt-center"> 
        <h2 id="bo_v_title" >
            <span class="bo_v_tit" style="font-size:20px;">
            <?php
            echo $view['wr_subject']; // 글제목 출력
            ?></span>
			<span class="bo_v_tit txt-point" style="display:block; margin-top:10px;">
            <?php
            echo $view['wr_10']; // 출처 출력
            ?></span>
			<span class="bo_v_tit txt-point" style="display:block;">
        	- <?php
            echo $view['wr_9']; // 출처 출력
            ?></span>
        </h2>  
